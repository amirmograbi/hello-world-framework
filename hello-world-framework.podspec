...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of hello-world-framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/amograbi15/hello-world-framework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'amograbi15' => 'amir.mograbi@oath.com' }
  s.source           = { :git => 'https://github.com/amograbi15/hello-world-framework.git', :tag => s.version.to_s }
